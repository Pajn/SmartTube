...
public class PlayerTweaksData implements ProfileChangeListener {
    ...
    private boolean mIsSmoothVideoStartEnabled;
    ...
    public boolean isSmoothVideoStartEnabled() {
        return mIsSmoothVideoStartEnabled;
    }

    public void setSmoothVideoStartEnabled(boolean enable) {
        mIsSmoothVideoStartEnabled = enable;
        persistData();
    }
    ...
    private void restoreData() {
        ...
        mIsSmoothVideoStartEnabled = Helpers.parseBoolean(split, 61, false);
