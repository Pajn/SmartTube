{
  description = "SmartTube development shell (JDK + Android SDK)";
  ...
  outputs = { nixpkgs, ... }:
    let
      ...
      # Keep in sync with SharedModules/constants.gradle.
      platformVersion = "34";
    ...
    in
    {
      devShells = forAllSystems (pkgs:
        let
          # Gradle 7.5 and Android Gradle Plugin 7.4.2 require JDK 11+.
          jdk = pkgs.jdk11;
          ...
          mkDevShell = { withEmulator }:
            ...
            pkgs.mkShell {
              ...
              '' + pkgs.lib.optionalString pkgs.stdenv.hostPlatform.isLinux ''
                # AGP's aapt2 comes from Maven as an unpatched ELF binary; use
                # the SDK's executable instead.
